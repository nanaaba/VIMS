...
<!--                                                                     <img src="{{ asset('img/text.png')}}" style="height: 38px;" alt="GRA">-->
    ...
    <div class="pull-right">
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span> <a href="{{url('logout')}}" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fas fa-sign-out-alt"></i></a> </span>
        </div>
        <!-- end logout button -->
        ...
        <form  action="{{url('search')}}" method="get"  class="header-search pull-right">
            <input id="search-fld" type="text" name="searchparam" placeholder="Number Plate, Chasis Number etc" 
                  >
            <button type="submit">

...
<html lang="en-us">
	...
	<body class="">
		...
		<script>
			if (!window.jQuery) {
				document.write('<script src="<?php echo e(asset('js/libs/jquery-3.2.1.min.js')); ?>"><\/script>');
			}
		</script>
		...
		<script>
			if (!window.jQuery.ui) {
				document.write('<script src="<?php echo e(asset('js/libs/jquery-ui.min.js')); ?>"><\/script>');
			}
		</script>

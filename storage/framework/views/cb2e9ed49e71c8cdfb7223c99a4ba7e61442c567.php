                ...
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li class="<?php echo e(Request::is('dashboard') ? 'active' : ''); ?>">
                         ...
                         <li class="<?php echo e(Request::is('agentcases*') ? 'active' : ''); ?>"><a href="<?php echo e(url('agentcases')); ?>"><i class="icon mdi mdi-account"></i><span> Reported Cases</span></a>
                        </li>
                        ...
                        <li class="<?php echo e(Request::is('reports*') ? 'active' : ''); ?>"><a href="<?php echo e(url('reports')); ?>"><i class="icon mdi mdi-account"></i><span>Report</span></a>
                        </li>
